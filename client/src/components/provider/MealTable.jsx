...
export default function ProductPage() {
  ...
  return (
    <>
      {foods && <div className=''>
        <UpdateFoodModel open={foodModal} setOpen={setFoodModal} foodDetails={activeFood} />
                ...
                <StyledTableRow key={food.name}>
                  ...
                  <StyledTableCell align='center'>
                    <div className='flex gap-2 items-center justify-center'>
                      <button className='border px-1 pr-2 py-1 flex items-center rounded-md  text-white bg-blue-600' style={{ gap: '1px' }} onClick={() => UpdateFoodModal(food)}>
