        ...
        <img src={Aboutusimg} alt="About us img" className="h-full w-full heighta" style={{width:"100vw"}}  />
            <div className="py-4">
              ...
              Tiffin Buudy is an attempt to provide a service that connects people with best of their neighborhoods across various cities. We strive to enable local businesses to meet consumers’ needs of ease and convenience, and, in turn, generate new ways for people to earn, work, and live. By providing our services to local commerce, we’re trying to fulfill our mission to grow and empower local economies.
                ...
                <p className="px-8 font-semibold text-sm sm:text-md lg:text-lg"> <span className="font-bolder  text-xl">*</span> motive of our project :</p> 
                <p className="px-8 py-1 text-justify text-sm sm:text-md lg:text-lg">&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;During our time in college, we noticed  lack of ease in dining, whether its breakfast, lunch, or dinner.  So, we thought of creating a website to showcase different messes,home kitchens and caterers in the locale.  </p>
                
                <p className="px-8 py-1 text-justify text-sm sm:text-md lg:text-lg">&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;To provide convenience for students in searching through various food providers, messes, caterers, we came up with an idea to create a website to address these issues.</p>
            </div>
        </>
    );
}
