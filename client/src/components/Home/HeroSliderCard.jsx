    ...
    <div>
      <div className='flex justify-between sm:items-center items-start my-2 gap-1 py-6 heroSlider'>
        <div className='flex flex-col gap-4 items-center lg:px-24 md:px-4 justify-center w-1/2'>
          <h1 className='md:text-4xl sm:text-2xl text-lg text-left sm:font-bold font-semibold  font-mono text-green-900'>{title}</h1>
          <button className='bg-orange-400 font-semibold py-2 sm:w-full w-full  text-white rounded-md' onClick={() => navigate("/provider")}>Book Your Tiffin</button>
        </div>
