...
import s1 from '../../images/thali1.jpeg'

function HeroSlider() {
  const slidesData = [
    {
      title: "Get Your Meals from Curated Home Chefs Around You",
      img: "https://alignthoughts.com/wp-content/uploads/2016/10/align-thoughts-indian-thali.jpg"
      //img  : "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKO0imCCGCWjPOK0pNloIoYKU3J1I65jp12GmXbG3pniOrRPdyjvqCorPjIQ&s"
      
    },
    {
      title: "Meal plans made easy, taste guaranteed.",
    ...
    {
      title: "Life is uncertain. Order your  favorite meal anytime and anywhere.",
